...
public class AddBalanceRequest extends BaseRequest<ResponseBody> {

	private long mUserId;

	private int mAmount;

	protected AddBalanceRequest(Builder builder) {
		super(builder);
	...
	public RequestRouter<ResponseBody> send() {
		send(getApi().addBalance(mUserId, mAmount));
		return this;
	}
	...
	public static class Builder extends BaseRequest.Builder<ResponseBody> {
		...
		public RequestRouter<ResponseBody> build() {
			...
			return new AddBalanceRequest(this);
		}
	}
}
